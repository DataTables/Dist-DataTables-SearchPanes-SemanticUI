...
narrowSearch:"dtsp-narrowSearch",narrowSub:"dtsp-narrow",paneButton:"ui",paneInputButton:"circular search link icon",topRow:"row dtsp-topRow"});b.extend(!0,a.SearchPanes.classes,{clearAll:"dtsp-clearAll ui button",collapseAll:"dtsp-collapseAll ui button",disabledButton:"disabled",showAll:"dtsp-showAll ui button"});a.SearchPane.prototype._searchContSetup=function(){b('<i class="'+this.classes.paneInputButton+'"></i>').appendTo(this.dom.searchCont)};return a.searchPanes});
